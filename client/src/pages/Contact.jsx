...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact — Amoda Candles</title>
        <meta name="description" content="Get in touch with Amoda Candles via form, WhatsApp, or Instagram." />
      </Helmet>
      ...
      <div className="pt-24 pb-16 min-h-screen">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h1 className="section-heading">Say Hello</h1>
            <p className="font-sans text-secondary">We'd love to hear from you.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              {[
                ...
                <div key={key}>
                  <label className="block font-sans text-sm text-secondary mb-1.5">{label}</label>
                  <input
                    type={type}
                    value={form[key]}
                    onChange={set(key)}
              ...
              <div>
                <label className="block font-sans text-sm text-secondary mb-1.5">Message</label>
                <textarea
                  value={form.message}
                  ...
                  required
                  rows={5}
                  className="w-full border border-accent rounded-candle px-4 py-3 font-sans text-sm focus:outline-none focus:border-primary transition-colors resize-none"
                />
              </div>
            ...
            >
              <div className="bg-white rounded-candle shadow-card p-6">
                ...
                {whatsappNumber && (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-sans font-medium text-green-800">WhatsApp</p>
              ...
              <div className="bg-accent/40 rounded-candle p-5">
                <p className="font-sans text-sm text-secondary leading-relaxed">
                  <strong className="text-text-dark">Response time:</strong> We typically reply within
                  2-4 hours on WhatsApp and Instagram during business hours (10am – 8pm IST, Mon–Sat).
                </p>
              </div>
            </motion.div>
          </div>
